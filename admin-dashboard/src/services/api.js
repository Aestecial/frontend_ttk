...
export const getCurrentUser = async () => {
  ...
  const response = await api.get('/api/current_user/', config);
...
export const createUsers = async (clientData, config) => {
  try {
    const response = await api.post('/api/users/create/', clientData, config);
    return response.data;
  } catch (error) {
...
export const deleteUsers = async (id, config) => {
  try {
